...
public final class Position {
    ...
    private final int x;
    private final int y;
    /** Used only by the frontend, irrelevant for the backend */
    ...
    /** Distance from origin position `(0, 0)` */
    ...
    /**
     * Returns the layer of this position.
     *
     * Positions with a higher layer are displayed on top of positions with lower layers in the front-end.
     */
    ...
    /** Return whether two positions are cardinally adjacent */
